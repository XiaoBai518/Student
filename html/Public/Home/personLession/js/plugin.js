define(function(require, exports, module) {
    ...
    var BatAdd = require("/html/Public/Home/js/bataddq.js");
    var API = require('API');
    var logDebug = true;
    ...
    exports.templateConfig = function(tplObj){
        ...
        template.helper('date2', function (unixTime) {
        	if(unixTime <= 0) return unixTime;
            return exports.time_format_year_month_day_hour_min(unixTime);
        });
    ...
    exports.getFileExtIcon = function(ext) {
        if (ext == null || ext == "") {
            return "/Public/Common/img/fileicon/wjj64.png";
        }
        var picUrl = "/Public/Common/img/fileicon/file_ext_big_";
        var extArray = ["pdf","doc","docx","zip","xls","xlsx","vsd","psd","ppt","pptx","html","rar","wps","et","dps"];
    ...
    exports.openkfeframe = function(type){
        var layero = layer.open({
            ...
            scrollbar:false,
            area: ['782px','490px'],
            content: '/Public/Common/js/lib/wangEditor/js/kityFormulaDialog.html',
            shift: 7,
            moveType: 1,
    ...
    exports.setUeditorSim = function(id,callback){
        var htmlstr = '';
        if($('#' + id).get(0).nodeName=='TEXTAREA'){
            htmlstr = $('#' + id).val();
        }else if($('#' + id).get(0).nodeName=='DIV'){
