...
(function() {
  ...
  AttachmentButton = (function(_super) {
	    ...
	    function AttachmentButton(editor) {
	      this.editor = editor;
	      AttachmentButton.__super__.constructor.call(this, this.editor);
	      if (this.editor.uploader == null) {
	        throw new Error('simditor: attachment button depend on uploader.coffee');
	      }
	      $.extend(this._tpl, {
	        attachment: "<div class='attachment'>\n  <div class='thumb-wrap'>\n    <img src='/Public/static/soon/images/fileicon/file_ext_small_others.png' class='file'/>\n  </div>\n  <span class='name'></span>\n  <span class='size'></span>\n <input type='hidden' name='myattachment[]' class='myattachment'/> <div class='progress-bar'><div><span></span></div></div>\n  <span class='percent'>0%</span>\n  <a href='javascript:;' class='link-cancel' title='Cancel'>Cancel</a>\n</div>"
	      });
	    }
	    ...
	    AttachmentButton.prototype.render = function() {
	      ...
	      this.attachmentList.on('click', '.link-cancel', (function(_this) {
	        return function(e) {
	          ...
	          attachmentEl.find(".myattachment").remove();
	    ...
	    AttachmentButton.prototype._initUploader = function() {
	      ...
	      createInput = (function(_this) {
	        return function() {
	          ...
	          _this.input = $('<input type="file" name="upload-file" tabIndex="-1" multiple="true" />');
	          if (_this.menu) {
	      ...
	      createInput();
	      this.wrapper.on('click mousedown', 'input[name=upload-file]', (function(_this) {
	        return function(e) {
	          return e.stopPropagation();
	        };
	      })(this));
	      this.wrapper.on('change', 'input[name=upload-file]', (function(_this) {
	        return function(e) {
	          _this.editor.uploader.upload(_this.input, {
	            attachment: true
	          });
	      ...
	      this.editor.uploader.on('beforeupload', (function(_this) {
	        return function(e, file) {
	          ...
	          if (file.size && file.size / 1048576 > 50) {
	        	...
	        	layer.alert("抱歉，本地文件最大只支持 50M",-1,"温馨提醒");
	            return false;
	          }
	          ...
	          _this.editor.uploader.readImageFile(file.obj, function(img) {
	            ...
	            if (img) {
	              ...
	              //imgPath = "<%= asset_path 'file_icons/' %>";
	            	imgPath = "/Public/static/soon/images/fileicon/";
	                imgUrl = imgPath + "file_ext_small_" + file.ext + ".png";
	                //imgUrl = imgPath + "file_extension_others.png";
	              img = new Image();
	              img.src = imgUrl;
	              img.onload = function() {
	                return attachEl.find("img").attr("src", imgUrl);
	              };
	              return img.onerror = function() {
	                return attachEl.find("img").attr("src", imgPath + "file_ext_small_others.png");
	              };
	            }
	          });
	          if (_this.editor.uploader.html5) {
	            ...
	            attachEl.find('.progress-bar').remove().end().find('.percent').text('正在上传...').addClass('ie');
	          }
	      ...
	      this.editor.uploader.on('uploadsuccess', (function(_this) {
	        return function(e, file, result) {
	          ...
	          attachEl.find(".myattachment").val(result.attach);
	      ...
	      return this.editor.el.data('droppable', 'true').attr('data-droppable', 'true').on('dropCustom', (function(_this) {
	        return function(e, evt, files) {
	          e.preventDefault();
	          e.stopPropagation();
